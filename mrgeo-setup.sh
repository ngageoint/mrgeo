...
export MRGEO_COMMON_HOME=/home/hadoop/mrgeo
export MRGEO_CONF_DIR=/home/hadoop/mrgeo/conf
...
sudo sh -c "echo -e 'export MRGEO_COMMON_HOME=/home/hadoop/mrgeo' >> $PROFILE"
sudo sh -c "echo -e 'export MRGEO_CONF_DIR=/home/hadoop/mrgeo/conf' >> $PROFILE"
