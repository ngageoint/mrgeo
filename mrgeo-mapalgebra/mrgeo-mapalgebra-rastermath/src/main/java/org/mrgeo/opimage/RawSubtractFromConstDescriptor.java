 ...
 *
 */
public class RawSubtractFromConstDescriptor extends OperationDescriptorImpl implements
RenderedImageFactory
{
  private static final long serialVersionUID = 1L;
  public final static int COLOR_SCALE = 0;
  public static final String OPERATION_NAME = RawSubtractFromConstDescriptor.class.getName();

  public static RenderedOp create(RenderedImage src1, double c)
  {
    ParameterBlock paramBlock = (new ParameterBlock()).addSource(src1).add(new Double(c));
    return JAI.create(OPERATION_NAME, paramBlock, null);
  }

  public RawSubtractFromConstDescriptor()
  {
  ...
  {
    return  RawSubtractFromConstOpImage.create(paramBlock.getRenderedSource(0),
        ((Double)paramBlock.getObjectParameter(0)).doubleValue());
  }
