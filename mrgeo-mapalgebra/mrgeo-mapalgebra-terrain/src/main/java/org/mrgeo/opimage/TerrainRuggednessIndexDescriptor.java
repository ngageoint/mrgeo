 ...
 * 
 */
public class TerrainRuggednessIndexDescriptor extends OperationDescriptorImpl implements
RenderedImageFactory
{
  public static final String OPERATION_NAME = TerrainRuggednessIndexDescriptor.class.getName();
  ...
  public TerrainRuggednessIndexDescriptor()
  {
  ...
  public RenderedImage create(ParameterBlock paramBlock, RenderingHints hints)
  {
    ...
    return TerrainRuggednessIndexOpImage.create(paramBlock.getRenderedSource(0), hints);
  }
