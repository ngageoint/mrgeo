...
public class HdfsMrsImagePyramidInputFormatOld extends SequenceFileInputFormat<TileIdWritable,RasterWritable>
{
  private static Logger LOG = LoggerFactory.getLogger(HdfsMrsImagePyramidInputFormatOld.class);
   ...
   */
  public HdfsMrsImagePyramidInputFormatOld()
  {
  }

  public HdfsMrsImagePyramidInputFormatOld(final String input, final int zoom)
  {
    this.input = input;
    this.inputZoom = zoom;
  }
...
//    job.setInputFormatClass(HdfsMrsImagePyramidInputFormat.class);
  ...
  protected List<FileStatus> listStatus(JobContext job) throws IOException
  {
    ...
    Path inputWithZoom = new Path(getZoomName(dp, inputZoom));

    // We are going to read all of the input dirs
    Path[] dirs = new Path[] { inputWithZoom} ;
    ...
    {
      System.out.println(new Path(inputWithZoom, split.getName()));
    }
