...
import org.mrgeo.hdfs.vector.shp.exception.InvalidPropertyException;
import org.mrgeo.hdfs.vector.shp.exception.PropertyNotFoundException;
import org.mrgeo.hdfs.vector.shp.util.jdbc.JDBCConnectionImpl;
import org.mrgeo.hdfs.vector.shp.util.jdbc.JDBCListener;
import org.mrgeo.hdfs.vector.shp.util.jdbc.JDBCPoolException;
...
@SuppressFBWarnings(value = "DE_MIGHT_IGNORE", justification = "Ignored exception ok")
