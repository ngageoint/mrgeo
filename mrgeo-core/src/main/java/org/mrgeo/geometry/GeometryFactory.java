...
{
  return ArrayUtils.addAll(PointImpl.getClasses(),
      ArrayUtils.addAll(LineStringImpl.getClasses(),
          ArrayUtils.addAll(LinearRingImpl.getClasses(),
              ArrayUtils.addAll(PolygonImpl.getClasses(),
