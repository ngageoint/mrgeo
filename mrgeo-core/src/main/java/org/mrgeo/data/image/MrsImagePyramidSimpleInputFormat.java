...
import org.mrgeo.data.MrsPyramidSimpleInputFormat;
 ...
 */
public class MrsImagePyramidSimpleInputFormat extends MrsPyramidSimpleInputFormat<RasterWritable>
{
  @Override
  public RecordReader<TileIdWritable, RasterWritable> createRecordReader(InputSplit inputSplit,
                                                                                 TaskAttemptContext context) throws IOException, InterruptedException
  {
    return new MrsImagePyramidSimpleRecordReader();
  }
