...
public class HdfsImageInputStream extends ImageInputStreamImpl
{
  private static Logger log = LoggerFactory.getLogger(HdfsImageInputStream.class);

  final private FSDataInputStream _input;
  final private Stack<Long> stack = new Stack<Long>();

  public HdfsImageInputStream(final FSDataInputStream input)
  {
    try
    {
      bitOffset = 0;
  ...
  public int read() throws IOException
  {
    ...
    log.debug("read (1) - {} (pos: {} time: {} ms)", 
        new Object[] { result, streamPos, System.currentTimeMillis() - start});
    return result;
  }
  ...
  public int read(final byte[] b, final int off, final int len) throws IOException
  {
    ...
    log.debug("read {} (pos: {} time: {} ms)", 
        new Object[] { bytesread, streamPos, System.currentTimeMillis() - start});
