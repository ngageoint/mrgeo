...
private static String getResponse(HttpResponse response, ContentType expectedContentType)
 ...
 * @throws ClientProtocolException
 */
public String postJson(String url, String jsonEntity, Map<String, String> requestHeaders)
    throws IOException, HttpResponseException,
    ClientProtocolException
{
 ...
 * @throws ClientProtocolException
 */
public String putJson(String url, String jsonEntity, Map<String, String> requestHeaders)
    throws IOException, HttpResponseException,
    ClientProtocolException
{
...
private String postPutJson(Request request, String jsonEntity, Map<String, String> requestHeaders)
    throws IOException, HttpResponseException,
    ClientProtocolException
{
