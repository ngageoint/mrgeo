...
//  }
  ...
  {
    Assert.assertEquals("Number of levels does not match the metadata", noPyramidsMeta.getMaxZoomLevel(), noPyramids.getNumLevels());
  }
  ...
  {
    Assert.assertEquals("Maximum zoom level does not match the metadata", noPyramidsMeta.getMaxZoomLevel(), noPyramids.getMaximumLevel());
  }
