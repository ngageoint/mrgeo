...
public class ColorScaleTest 
{
  ...
  public void testLoadXmlDefaults() throws ColorScaleException
  {
    ...
    Assert.assertTrue(Scaling.Absolute.name().equals(cs.getScaling().name()));
  ...
  @Test
  @Category(UnitTest.class)
  public void testLoadXmlTags() throws ColorScaleException
  {
    String xml = "<ColorMap name=\"Rainbow\">";
    ...
    Assert.assertTrue(Scaling.MinMax.name().equals(cs.getScaling().name()));
  ...
  @Test
  @Category(UnitTest.class)
  public void testLoadXmlTagsEmpty() throws ColorScaleException
  {
    String xml = "<ColorMap name=\"Rainbow\">";
  ...
  @Test
  @Category(UnitTest.class)
  public void testLoadJsonDefaults() throws ColorScaleException
  {
  ...
  @Test
  @Category(UnitTest.class)
  public void testLoadJson() throws ColorScaleException
  {
  ...
  @Test
  @Category(UnitTest.class)
  public void testSetDefault() throws ColorScaleException
  {
    ...
    Assert.assertTrue(Scaling.MinMax.name().equals(def.getScaling().name()));
  ...
  @Test
  @Category(UnitTest.class)
  public void testEquals() throws ColorScaleException
  {
    String xml = "<ColorMap name=\"Grayscale\">";
    xml +=  "<Scaling>MinMax</Scaling>";
    xml +=  "<Interpolate>1</Interpolate>";
  ...
  @Test
  @Category(UnitTest.class)
  public void testEqualsFalseWithScaleRange() throws ColorScaleException
  {
    String xml = "<ColorMap name=\"Grayscale\">";
    xml +=  "<Scaling>MinMax</Scaling>";
    xml +=  "<Interpolate>1</Interpolate>";
  ...
  public void testAbsoluteNoInterpolateForceValuesIntoRange() throws Exception
  {
    ...
    cs.setInterpolate(false);
    cs.setForceValuesIntoRange(true);
    cs.setScaling(Scaling.Absolute);
