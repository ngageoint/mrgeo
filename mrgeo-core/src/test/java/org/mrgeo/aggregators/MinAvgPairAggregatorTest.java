...
public class MinAvgPairAggregatorTest
{
...
public void testDouble()
{
  ...
  double result;
  Aggregator agg = new MinAvgPairAggregator();

  //Test normal case
  result = agg.aggregate(values, nodata);
  assertEquals(0.265, result, epsilon);

  //Test nodata cases
  values[0] = nodata;
  result = agg.aggregate(values, nodata);
  assertEquals(0.375, result, epsilon);

  values[1] = nodata;
  result = agg.aggregate(values, nodata);
  assertEquals(0.485, result, epsilon);
