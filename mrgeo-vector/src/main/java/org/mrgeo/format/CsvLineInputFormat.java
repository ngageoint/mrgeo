 ...
 */
public class CsvLineInputFormat extends CsvInputFormat implements RecordInputFormat
{
  private static final Logger llog = LoggerFactory.getLogger(CsvLineInputFormat.class);
