...
public class WcsGeneratorTestAbstract extends JerseyTest
{
...
private static final Logger log = LoggerFactory.getLogger(WcsGeneratorTestAbstract.class);
...
public static void setUpForJUnit()
{
  ...
  try
  {
    ...
    input = TestUtils.composeInputDir(WcsGeneratorTestAbstract.class);
    inputHdfs = TestUtils.composeInputHdfs(WcsGeneratorTestAbstract.class, true);
    copyInputData();
//      launchServlet();
    ...
    {
      log.warn("***WCS TESTS SET TO GENERATE BASELINE IMAGES ONLY***");
    }
  }
...
protected Application configure()
{
  ...
  config.register(WcsGenerator.class);
  return config;
}
